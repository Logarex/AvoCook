...
const translations = {
  ...
  fr: {
    ...
    feat_15_name: "Plateforme Communautaire",
    feat_15_desc: "Découvrez, notez, traduisez et importez des recettes de la communauté AvoCook. Créez votre profil et partagez vos plats.",
    feat_16_name: "Courses partagées & Notifications",
    feat_16_desc: "Collaborez en temps réel sur vos courses avec un code à 6 chiffres, notifications push en temps réel et suivi des participants.",
    ...
    tech_i18n: "Internationalisation complète en 6 langues avec détection automatique de la locale.",
  ...
  en: {
    ...
    feat_15_name: "Community Platform",
    feat_15_desc: "Discover, rate, translate, and import recipes from the AvoCook community. Set up a profile to share your best meals.",
    feat_16_name: "Shared Shopping Lists & Push Notifications",
    feat_16_desc: "Collaborate on grocery lists in real-time using a 6-digit code, live push notifications, and active participant tracking.",
    ...
    tech_i18n: "Full internationalisation in 6 languages with automatic locale detection.",
  ...
  de: {
    ...
    feat_15_name: "Community-Plattform",
    feat_15_desc: "Entdecke, bewerte, übersetze und importiere Rezepte aus der Community. Erstelle ein Profil und teile deine besten Gerichte.",
    feat_16_name: "Geteilte Einkaufslisten & Push-Mitteilungen",
    feat_16_desc: "Arbeite in Echtzeit an Einkaufslisten mit einem 6-stelligen Code zusammen — inkl. Push-Benachrichtigungen und Teilnehmeranzeige.",
    tag_optional: "Optional",
    ...
    tech_i18n: "Vollständige Internationalisierung in 6 Sprachen mit automatischer Erkennung.",
  ...
  es: {
    ...
    feat_15_name: "Plataforma de la Comunidad",
    feat_15_desc: "Descubre, califica, traduce e importa recetas de la comunidad AvoCook. Crea tu perfil y comparte tus mejores platos.",
    feat_16_name: "Listas de Compras Compartidas y Notificaciones",
    feat_16_desc: "Colabora en tiempo real en tus compras mediante un código de 6 dígitos, notificaciones push y seguimiento de participantes.",
    ...
    tech_i18n: "Internacionalización completa en 6 idiomas con detección automática.",
  ...
  it: {
    ...
    feat_15_name: "Piattaforma Comunità",
    feat_15_desc: "Scopri, valuta, traduci e importa le ricette della community. Crea il tuo profilo e condividi i tuoi piatti migliori.",
    feat_16_name: "Liste Spesa Condivise e Notifiche Push",
    feat_16_desc: "Collabora in tempo reale alle liste della spesa con un codice a 6 cifre, notifiche push e tracciamento dei partecipanti.",
    ...
    tech_i18n: "Internazionalizzazione completa in 6 lingue con rilevamento automatico.",
  ...
  da: {
    ...
    hero_subtitle: "Fungerer helt offline, ingen konto påkrævet. Nextcloud-synkronisering tilgængelig, hvis du ønsker det.",
    hero_note: "Lokal tilstand — ingen konto påkrævet. Dine data forbliver på din enhed.",
    hero_cta_appstore: "App Store",
    hero_cta_playstore: "Google Play",
    hero_cta_apk: "Android APK",
    ...
    stat_downloads: "downloads",
    stat_offline: "offline",
    screenshot_placeholder: "Skærmbillede på vej",
    features_label: "Funktioner",
    features_title: "Alt hvad du har brug for",
    features_subtitle: "En komplet opskriftsbog, intet overflødigt.",
    feat_1_name: "Opret & rediger",
    feat_1_desc: "Skriv opskrifter helt fra bunden, trin for trin. Rediger dem når som helst uden internet.",
    feat_2_name: "Kategorier",
    feat_2_desc: "Organiser opskrifter efter kategori (forretter, desserter, hurtige retter...). Filtrer med ét tryk.",
    feat_3_name: "Tilpas portioner",
    feat_3_desc: "Skift antallet af portioner, og alle mængder opdateres automatisk. Ingen hovedregning.",
    feat_4_name: "Billeder",
    feat_4_desc: "Tilføj et eller flere billeder pr. opskrift fra dit bibliotek eller direkte fra kameraet.",
    feat_5_name: "PDF & udskriv",
    feat_5_desc: "Eksporter enhver opskrift som en PDF-fil, eller send den direkte til udskrivning.",
    feat_6_name: "Del en opskrift",
    feat_6_desc: "Del en opskrift med en anden app via systemets standard delingsmenu.",
    feat_7_name: "Import fra URL",
    feat_7_desc: "Indsæt et link fra enhver opskriftsside — den importeres automatisk via schema.org/Recipe.",
    feat_8_name: "Del fra din browser",
    feat_8_desc: "Finder du en opskrift online? Del siden fra din browser til AvoCook. Import med ét tryk.",
    feat_9_name: "AI-generering",
    feat_9_desc: "Scan en opskrift fra et foto, eller beskriv en ret for at få en komplet opskrift. OpenAI-kompatibel.",
    feat_10_name: "Indkøbsliste",
    feat_10_desc: "Kopier ingredienser til udklipsholderen med ét tryk, eller eksporter en liste til Apple Påmindelser.",
    feat_11_name: "Timere",
    feat_11_desc: "Start en eller flere tilberedningstimere direkte fra en opskrift. Lokal meddelelse i baggrunden.",
    feat_12_name: "Sikkerhedskopi & genopretning",
    feat_12_desc: "Eksporter alle dine opskrifter til en JSON-fil, og genopret dem når som helst på enhver enhed.",
    feat_13_name: "Nextcloud-synkronisering",
    feat_13_desc: "Forbind din egen Nextcloud Cookbook-server for at synkronisere opskrifter på tværs af enheder. Helt valgfrit.",
    feat_14_name: "100% offline & privat",
    feat_14_desc: "AvoCook fungerer uden internetforbindelse. Ingen konto, ingen sporing, ingen tredjepartsserver.",
    feat_15_name: "Fællesskabsplatform",
    feat_15_desc: "Opdag, bedøm, oversæt og importer opskrifter fra fællesskabet. Opret en profil og del dine retter.",
    feat_16_name: "Delte indkøbslister & Push-meddelelser",
    feat_16_desc: "Samarbejd i realtid om indkøbslister med en 6-cifret kode, push-meddelelser og deltagersporing.",
    tag_optional: "Valgfrit",
    screenshots_label: "Forhåndsvisning",
    screenshots_title: "Appen i billeder",
    ph_home: "Startskærm",
    ph_list: "Opskriftsliste",
    ph_detail: "Opskriftsdetaljer",
    ph_editor: "Opskredigerer",
    ph_import: "URL-import",
    ph_shopping: "Indkøbsliste",
    ph_timer: "Timere",
    how_label: "Hvordan det fungerer",
    how_title: "Lokal først. Nextcloud hvis du vil.",
    how_subtitle: "AvoCook er designet til at fungere uden nogen konto. Nextcloud-synkronisering er en mulighed, ikke et krav.",
    local_title: "Lokal tilstand",
    local_desc: "Standardtilstanden. Ingen konto, ingen forbindelse nødvendig. Opskrifter gemmes direkte på din enhed.",
    local_p1: "Fungerer i flytilstand",
    local_p2: "Data forbliver kun på enheden",
    local_p3: "Ingen tredjepartsserver involveret",
    local_p4: "Manuel sikkerhedskopiering til JSON-fil",
    mode_or: "eller",
    nextcloud_title: "Nextcloud-synkronisering",
    nextcloud_desc: "Forbind din egen Nextcloud-server med Cookbook-appen. Data går direkte mellem appen og din server.",
    nextcloud_p1: "Kompatibel med Nextcloud Cookbook",
    nextcloud_p2: "Synkronisering mellem enheder",
    nextcloud_p3: "App-adgangskode, HTTPS påkrævet",
    nextcloud_p4: "Ingen tredjepart — kun din Nextcloud",
    import_label: "Smart import",
    import_title: "Importer fra enhver opskriftsside",
    import_subtitle: "AvoCook læser strukturerede schema.org/Recipe-data fra de fleste madwebsteder. Indsæt en URL, opskriften er klar på få sekunder.",
    and_many_more: "og mange flere",
    import_ai_title: "AI-import",
    import_ai_desc: "Tag et foto af en kogebogsside eller en ret — AvoCook kan generere en opskrift med en OpenAI-kompatibel model.",
    import_result_meta: "4 portioner · 45 min · Importeret",
    import_tag_ingredients: "12 ingredienser",
    import_tag_steps: "6 trin",
    import_tag_photo: "Billede inkluderet",
    about_label: "Projektet",
    about_title: "Bygget af en studerende, brugt hver dag",
    about_quote: "\"Mine opskrifter var spredt over fotos, Safari-faner og notater. Jeg besluttede at bygge den app, jeg manglede.\"",
    about_p1: "AvoCook startede som et personligt projekt under mine datologistudier.",
    about_p2: "Med tiden voksede projektet: native moduler, Nextcloud-synkronisering, opskriftsimport, AI-generering.",
    about_p3: "Appen er helt open source under GPLv3-licensen. Koden ligger på GitHub.",
    about_highlight_title: "Kontekst",
    about_highlight_text: "Datologistuderende · Personligt projekt · Bygget i Frankrig · Aktivt vedligeholdt",
    num_languages: "Sprog tilgængelige i appen",
    num_platforms: "Platforme — iOS og Android",
    num_license: "Open source-licens · Kode på GitHub",
    num_tracking: "Trackere · Analytics · Annoncer",
    tech_label: "Teknologi",
    tech_title: "Hvad der kører under motorhjelmen",
    tech_subtitle: "Et komplet React Native-projekt, ingen genveje.",
    tech_rn: "Cross-platform fundament. Expo til native moduler og CI/CD builds.",
    tech_ts: "Fuld typestyring fra komponent til datalag.",
    tech_sqlite: "Lokal opskriftslagring i en indlejret relationel database via expo-sqlite.",
    tech_i18n: "Fuld internationalisering på 6 sprog med automatisk sprogregistrering.",
    tech_secure: "Nextcloud-legitimationsoplysninger gemt i systemets sikre enklave.",
    tech_calendar: "Indkøbslistesynkronisering med Apple Påmindelser via native API.",
    tech_schema: "Opskriftsimport fra ethvert websted med strukturerede Recipe-data.",
    tech_native: "avocook-timer-notifications — lokale meddelelser til timere i baggrunden.",
    os_label: "Open source",
    os_title: "Koden er åben",
    os_p1: "AvoCook er udgivet under GPLv3-licensen. Du kan læse koden, forke den og bidrage.",
    os_link_repo: "GitHub-lager",
    os_link_releases: "Udgaver & APK",
    os_link_releases_sub: "Hent den seneste version",
    os_link_contrib: "Bidrag",
    os_link_contrib_sub: "Bidragsguide & PR-skabelon",
    os_link_issues: "Rapporter en fejl",
    os_link_issues_sub: "GitHub Issues",
    os_license_desc: "Du har frihed til at bruge, ændre og distribuere AvoCook under samme licens.",
    os_lic_p1: "Gratis at bruge",
    os_lic_p2: "Ændr og redistriuber",
    os_lic_p3: "Garanti for adgang til kildekode",
    os_lic_p4: "Copyleft — samme licens bevares",
    donate_label: "Støt",
    donate_title: "Finder du AvoCook nyttig?",
    donate_subtitle: "Appen er gratis og open source. En donation hjælper med at dække udviklingsomkostninger.",
    donate_revolut: "Doner via Revolut",
    donate_paypal: "Doner via PayPal",
    donate_note: "Intet minimumsbeløb. Alt værdsættes.",
    footer_copy: "Open source-projekt · GPLv3-licens · Lavet med omhu",
    footer_releases: "Udgaver",
    footer_privacy: "Privatliv",
    contact_label: "Kontakt",
    contact_title: "Et spørgsmål? En idé?",
    contact_subtitle: "Brug GitHub Issues til fejlrapporter og funktionønsker.",
    contact_email_label: "Via e-mail",
    contact_email_note: "Brug helst GitHub Issues til fejl eller funktioner.",
    contact_gh_label: "Via GitHub",
    contact_gh_cta: "Åbn et issue",
    contact_gh_note: "Fejl, funktionønsker, tekniske spørgsmål.",
    apk_sub: "GitHub Releases",
  },
};
