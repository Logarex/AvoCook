export default {
  translation: {
    ...
    update: {
      ...
      feat2Body: "Le partage depuis Safari ou une autre app vers AvoCook fonctionne à nouveau. Support des fichiers .avocook partagés.",
      feat3Title: "IA accessible plus facilement",
      feat3Body: "La section IA est maintenant ouverte par défaut et les modèles disponibles se chargent automatiquement.",
      feat4Title: "Corrections d'affichage",
      feat4Body: "Boutons des journaux et des réglages mieux affichés, textes tronqués corrigés, rubriques avancées sans chevauchement.",
