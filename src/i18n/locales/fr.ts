export default {
  translation: {
    ...
    update: {
      ...
      feat1Title: "Améliorations de l'interface",
      feat1Body: "Amélioration de l'accessibilité de l'introduction, meilleur affichage des titres et des boutons. Mise à jour du style de la barre latérale.",
      feat2Title: "Meilleure localisation",
      feat2Body: "L'anglais est désormais la langue par défaut. Les portions utilisent maintenant le formatage décimal adapté à votre région.",
      feat3Title: "Liens d'assistance",
      feat3Body: "Ajout d'un lien direct vers le site d'assistance AvoCook dans l'écran des réglages.",
      feat4Title: "Corrections du mode sombre",
      feat4Body: "La couleur de fond de l'écran de chargement a été mise à jour pour s'adapter parfaitement au mode sombre.",
