export default {
  translation: {
    ...
    update: {
      title: "Quoi de neuf ?",
      subtitle: "Découvrez les nouveautés de la version 3.4.1",
      feat1Title: "Plus fluide et rapide",
      feat1Body: "L'application a été allégée et optimisée en supprimant le superflu. Le résultat : moins de bugs et plus de rapidité.",
      feat2Title: "Navigation alphabétique",
      feat2Body: "Le bouton de défilement a été remplacé par un index alphabétique pour retrouver vos recettes en un clin d'œil.",
      feat3Title: "Catégories favorites",
      feat3Body: "Ajoutez une étoile à vos catégories préférées pour y accéder directement. La catégorie 'Autre' regroupe les recettes sans catégorie.",
      feat4Title: "Interface simplifiée",
      feat4Body: "Les boutons des listes et menus sont plus clairs, et un bouton permet de passer du mode Local à Nextcloud facilement.",
