export default {
  translation: {
    ...
    auth: {
      ...
      debugLogsTitle: "Logs & Débogage",
      shareLogs: "Logs de connexion & Débogage",
      copied: "Copié !",
      logCount: "{{count}} entrées enregistrées",
      noLogsYet: "Aucun log enregistré pour le moment.",
      sslWarningTitle: "Problème de certificat SSL / TLS",
      selfSignedNotice:
    ...
    importRecipe: {
      ...
      cropInstructionsTitle: "Cadrez le texte de la recette",
      cropInstructionsBody: "Isolez la zone contenant le texte de la recette (titre, ingrédients, étapes) pour permettre à l'IA de l'analyser. Vous pourrez ensuite choisir ou recadrer la photo du plat.",
    ...
    update: {
      title: "Quoi de neuf ?",
      subtitle: "Notifications Push, Traduction Communautaire & Correctifs (v4.0.1)",
      feat1Title: "Notifications & Listes Partagées",
      feat1Body: "Recevez des notifications push en temps réel lors de la modification de vos listes de courses partagées et suivez les participants actifs.",
      feat2Title: "Traduction & Communauté",
      feat2Body: "Traduisez les recettes communautaires directement dans l'application, découvrez les aperçus d'images et explorez les recettes sans filtre par défaut.",
      feat3Title: "Correctifs & Interface",
      feat3Body: "Correction du comportement du clavier dans les descriptions, résolution de l'affichage des images locales et validation renforcée des pseudos.",
      feat4Title: "Performances & Sous le capot",
      feat4Body: "Optimisation de la fluidité du défilement des listes et migration vers le SDK Firebase modulaire pour une sécurité et stabilité accrues.",
