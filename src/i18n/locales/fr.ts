export default {
  translation: {
    ...
    auth: {
      ...
      localDataWarning:
        "Attention : en mode local, supprimer l'application supprime aussi les recettes stockées sur cet appareil. Faites des sauvegardes régulières.",
      badCredentials:
    ...
    update: {
      title: "Quoi de neuf ?",
      subtitle: "Découvrez les nouveautés de la version 3.4.2",
      feat1Title: "Clavier plus intelligent",
      feat1Body: "Comportement du KeyboardAvoidingView amélioré et gestion du focus et des interactions sur la liste de courses optimisée.",
      feat2Title: "Upload d'images à distance",
      feat2Body: "L'éditeur de recettes permet désormais d'importer des images directement depuis une URL, avec des indicateurs de chargement en temps réel.",
      feat3Title: "Mots-clés de catégories enrichis",
      feat3Body: "Les listes de mots-clés de catégories de recettes ont été élargies avec des termes multilingues et des synonymes pour une catégorisation automatique plus précise.",
      feat4Title: "Meilleure correspondance de catégories",
      feat4Body: "La correspondance des catégories utilise désormais des délimiteurs de mots, et les libellés d'affichage se resolvent correctement lors du renommage.",
