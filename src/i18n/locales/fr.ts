export default {
  translation: {
    ...
    update: {
      title: "Quoi de neuf ?",
      subtitle: "Découvrez les nouveautés de la version 3.4.3",
      feat1Title: "Nouvelles langues",
      feat1Body: "Ajout de la localisation en danois et mise à jour des invites d'importation de recettes pour préserver la langue originale.",
      feat2Title: "Liberté d'installation",
      feat2Body: "Suppression de la sécurité Play Integrity de Google permettant désormais de télécharger l'application depuis d'autres sources.",
      feat3Title: "",
      feat3Body: "",
      feat4Title: "",
      feat4Body: "",
