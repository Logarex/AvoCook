export default {
  translation: {
    ...
    update: {
      title: "Quoi de neuf ?",
      subtitle: "Découvrez les nouveautés de la version 4.0.0",
      feat1Title: "Recettes Communautaires",
      feat1Body: "Découvrez et partagez des recettes avec tous les utilisateurs d'AvoCook.",
      feat2Title: "Courses en Temps Réel",
      feat2Body: "Synchronisez et partagez vos listes de courses instantanément avec vos proches.",
      feat3Title: "Gestes Naturels",
      feat3Body: "Naviguez facilement entre vos recettes, la communauté et vos courses par balayage.",
      feat4Title: "Interface Repensée",
      feat4Body: "Nouveau design des cartes communautaires et améliorations visuelles globales.",
