export default {
  translation: {
    ...
    tour: {
          ...
          step2Title: "Créer une recette",
          step2Body: "Appuyez sur le bouton « + » pour ajouter vos propres recettes, avec les ingrédients et les étapes.",
          step3Title: "Importer une recette",
          step3Body: "Collez un lien internet et AvoCook se charge d'importer la recette pour vous automatiquement.",
