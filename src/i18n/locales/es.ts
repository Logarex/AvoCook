export default {
  translation: {
    ...
    update: {
      ...
      subtitle: "Descubre las novedades de la versión 3.4.3",
      feat1Title: "Nuevos idiomas",
      feat1Body: "Se añadió soporte de localización en danés y se actualizaron las indicaciones de importación de recetas para conservar el idioma original.",
      feat2Title: "Libertad de instalación",
      feat2Body: "Se eliminó la seguridad de Play Integrity de Google, permitiendo ahora descargar la aplicación desde otras fuentes.",
      feat3Title: "",
      feat3Body: "",
      feat4Title: "",
      feat4Body: "",
