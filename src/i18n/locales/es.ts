export default {
  translation: {
    common: {
      ...
      continue: "Continuar",
      longActionNotice:
        "{{action}} está en curso. Por favor, espera.",
    },
    longActions: {
    ...
    shoppingList: {
      ...
      notificationTitle: "Lista de la compra compartida",
      notificationAdded: "Se han añadido nuevos elementos a la lista de la compra.",
      notificationRemoved: "Se han eliminado elementos de la lista de la compra.",
      notificationAddedAndRemoved: "Se han añadido y eliminado elementos de la lista de la compra.",
    ...
    community: {
      ...
      translateRecipe: "Traducir receta",
      showOriginal: "Ver original",
      translating: "Traduciendo...",
      translationFailed: "Traducción fallida",
      translatedNotice: "Traducido automáticamente",
      ...
      importDuplicateError: "Esta receta ya está en tu recetario.",
      ...
      profanityError: "Evite usar palabras inapropiadas.",
      ...
      duplicateRecipeError: "Ya existe una receta similar en la comunidad.",
      importCategoryLabel: "Comunidad",
      importKeyword: "comunidad",
      shareConfirmTitle: "¿Compartir receta?",
    ...
    editor: {
      ...
      cholesterolMg: "Colesterol (mg)",
      transFatGrams: "Grasa trans (g)",
      unsaturatedFatGrams: "Grasa insaturada (g)",
    ...
    importRecipe: {
      ...
      cropInstructionsTitle: "Encuadra el texto de la receta",
      cropInstructionsBody: "Aísla la zona con el texto de la receta (título, ingredientes, pasos) para que la IA pueda analizarlo. A continuación, podrás seleccionar o recortar la foto del plato.",
    ...
    settings: {
      ...
      switchToNextcloud: "Cambiar a Nextcloud",
      switchToLocalConfirmTitle: "¿Cambiar a modo local?",
      switchToLocalConfirmBody: "Tus recetas de Nextcloud ya no se sincronizarán en este dispositivo. Tus recetas locales se mantienen por separado. ¡No se pierde ningún dato!",
      switchToNextcloudConfirmTitle: "¿Cambiar a Nextcloud?",
      switchToNextcloudConfirmBody: "Tus recetas locales actuales se conservarán en este dispositivo y se sincronizarán con tu cuenta de Nextcloud. ¡No se pierde ningún dato!",
      logoutConfirmTitle: "Cerrar sesión",
      logoutConfirmBody: "Su información de conexión se eliminará de este dispositivo.",
      title: "Ajustes",
      profanityError: "Evite usar palabras inapropiadas en su seudónimo.",
      ...
      sectionSupport: "Soporte e Información",
      keepAwake: "Mantener pantalla encendida en recetas",
      ...
      shoppingNotifications: "Notificaciones de la lista de la compra",
      shoppingNotificationsHint: "Notificar cuando otros miembros añadan o eliminen elementos",
      server: "Servidor",
      ...
      imageFolderPath: "Carpeta de imágenes de Nextcloud",
      imageFolderPathPlaceholder: "AvoCook Images",
      imageFolderPathHint: "Carpeta donde se almacenan las fotos de recetas en Nextcloud. Déjalo vacío para usar la carpeta predeterminada «AvoCook Images».",
      imageFolderPathMigrationWarning: "Las fotos ya subidas a la carpeta anterior (AvoCook Images) permanecen allí. No se eliminarán automáticamente al modificar recetas.",
    },
    logs: {
      title: "Registros",
      refresh: "Actualizar",
    ...
    onboarding: {
      ...
      feature9Body: "¿Encontraste un error o tienes una idea? Los botones para contactar al desarrollador siempre están en la aplicación: solo toca.",
      feature10Title: "Comunidad",
      feature10Body: "Comparte, califica y descubre recetas de otros usuarios en la plataforma de la Comunidad.",
      feature11Title: "Listas compartidas",
      feature11Body: "Colabora en tus listas de compras en tiempo real mediante un código de 6 dígitos.",
    },
    tour: {
      skip: "Saltar",
      ...
      stepCommunityTitle: "Comunidad",
      stepCommunityBody: "Descubre, califica e importa recetas de la comunidad AvoCook. ¡Comparte tus mejores comidas y crea tu perfil!",
      stepSharedListTitle: "Listas compartidas",
      stepSharedListBody: "Colabora en listas de compras en tiempo real con un simple código de 6 dígitos. ¡Todos se mantienen sincronizados!",
    ...
    update: {
      ...
      subtitle: "Notificaciones Push, Traducción de Comunidad y Correcciones (v4.0.1)",
      feat1Title: "Notificaciones Push y Listas Compartidas",
      feat1Body: "Recibe notificaciones en tiempo real cuando se actualicen las listas de compras compartidas y consulta los participantes activos.",
      feat2Title: "Traducción y Comunidad",
      feat2Body: "¡Traduce recetas comunitarias directamente en la app! Disfruta de vistas previas de imágenes y explora recetas sin restricciones de idioma.",
      feat3Title: "Correcciones de Interfaz",
      feat3Body: "Se solucionó el comportamiento del teclado en la descripción de recetas, se corrigió la visualización de imágenes locales y la validación de seudónimos.",
      feat4Title: "Rendimiento y Ajustes Internos",
      feat4Body: "Carga de listas optimizada para un desplazamiento más fluido y migración al SDK modular de Firebase para mayor seguridad y estabilidad.",
      continue: "Continuar a mis recetas",
      settingsButton: "Novedades de esta versión",
    },
  },
};
