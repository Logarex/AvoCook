export default {
  translation: {
    ...
    update: {
      ...
      subtitle: "Actualización de Comunidad y Compras (v4.0.0)",
      feat1Title: "Plataforma Comunitaria",
      feat1Body: "Comparte, califica e importa recetas. Crea un perfil, usa metadatos enriquecidos y disfruta de un espacio seguro con nueva moderación.",
      feat2Title: "Listas de Compras Compartidas",
      feat2Body: "Colabora en tiempo real en tus compras con un simple código de 6 dígitos e indicador de sincronización.",
      feat3Title: "Mejoras de Interfaz",
      feat3Body: "Selector rápido de categorías, mejores modales con orden alfabético, mejor tipografía y normalización de caracteres.",
      feat4Title: "Bajo el capó e Idiomas",
      feat4Body: "Soporte para danés, motor de traducción completo y rendimiento altamente optimizado.",
