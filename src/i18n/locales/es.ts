export default {
  translation: {
    ...
    importRecipe: {
      ...
      incompleteRecipe: "La importación automática está bloqueada por este sitio. Es probable que el autor haya desactivado la opción de compartir ingredientes y pasos para proteger su contenido.",
    },
    settings: {
    ...
    update: {
      ...
      subtitle: "Descubre las novedades de la versión 3.4.2",
      feat1Title: "Teclado más inteligente",
      feat1Body: "Comportamiento del KeyboardAvoidingView ajustado y manejo del foco y los toques en la lista de la compra optimizado.",
      feat2Title: "Carga de imágenes remota",
      feat2Body: "El editor de recetas ahora permite subir imágenes directamente desde una URL, con indicadores de carga en tiempo real.",
      feat3Title: "Palabras clave de categorías más ricas",
      feat3Body: "Las listas de palabras clave de categorías de recetas se han ampliado con términos multilingües y sinónimos para una categorización automática más precisa.",
      feat4Title: "Mejor coincidencia de categorías",
      feat4Body: "La coincidencia de categorías ahora usa límites de palabras, y las etiquetas de visualización se resuelven correctamente al renombrar.",
