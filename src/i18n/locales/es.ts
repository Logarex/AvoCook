export default {
  translation: {
    ...
    update: {
      ...
      feat2Body: "Compartir desde Safari u otra app hacia AvoCook vuelve a funcionar. Los archivos .avocook también se pueden compartir directamente.",
      feat3Title: "IA más accesible",
      feat3Body: "La sección de IA está ahora abierta por defecto y los modelos disponibles se cargan automáticamente.",
      feat4Title: "Correcciones de visualización",
      feat4Body: "Los botones de Registros y Ajustes ya no se cortan. Diseño de la sección avanzada mejorado, sin superposiciones.",
