export default {
  translation: {
    ...
    update: {
      ...
      feat1Title: "Mejoras de interfaz",
      feat1Body: "Accesibilidad mejorada en la introducción, mejor visualización de encabezados y botones. Se actualizó el estilo de la barra lateral.",
      feat2Title: "Mejor localización",
      feat2Body: "El inglés es ahora el idioma por defecto. Las porciones ahora usan un formato decimal adaptado a tu región.",
      feat3Title: "Enlaces de soporte",
      feat3Body: "Se agregó un enlace directo al sitio web de soporte de AvoCook en la pantalla de ajustes.",
      feat4Title: "Correcciones del modo oscuro",
      feat4Body: "El color de fondo de la pantalla de carga se ha actualizado para adaptarse perfectamente al modo oscuro.",
