export default {
  translation: {
    ...
    update: {
      ...
      subtitle: "Descubre las novedades de la versión 3.4.1",
      feat1Title: "Más rápida y ligera",
      feat1Body: "La aplicación ha sido optimizada eliminando elementos innecesarios, lo que resulta en una experiencia más rápida y estable.",
      feat2Title: "Navegación alfabética",
      feat2Body: "El botón de desplazamiento ha sido reemplazado por un índice alfabético para encontrar tus recetas al instante.",
      feat3Title: "Categorías favoritas",
      feat3Body: "Añade una estrella a tus categorías favoritas para un acceso rápido. La categoría 'Otro' agrupa las recetas sin categoría.",
      feat4Title: "Interfaz simplificada",
      feat4Body: "Los menús y listas tienen botones más claros, y ahora puedes cambiar fácilmente entre el modo Local y Nextcloud.",
