export default {
  translation: {
    ...
    update: {
      ...
      subtitle: "Scopri le novità della versione 3.4.2",
      feat1Title: "Tastiera più intelligente",
      feat1Body: "Comportamento del KeyboardAvoidingView migliorato e gestione del focus e dei tocchi nella lista della spesa ottimizzata.",
      feat2Title: "Caricamento immagini remoto",
      feat2Body: "L'editor di ricette ora supporta il caricamento diretto di immagini tramite URL remoto, con indicatori di caricamento in tempo reale.",
      feat3Title: "Parole chiave di categoria più ricche",
      feat3Body: "Le liste di parole chiave delle categorie di ricette sono state ampliate con termini multilingue e sinonimi per una categorizzazione automatica più precisa.",
      feat4Title: "Corrispondenza categorie migliorata",
      feat4Body: "La corrispondenza delle categorie ora usa i limiti di parola, e le etichette di visualizzazione vengono risolte correttamente durante la ridenominazione.",
