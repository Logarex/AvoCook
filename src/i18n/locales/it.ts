export default {
  translation: {
    ...
    auth: {
      ...
      debugLogsTitle: "Log e Debug",
      shareLogs: "Log di Connessione e Debug",
      copied: "Copiato!",
      logCount: "{{count}} voci registrate",
      noLogsYet: "Nessun log ancora registrato.",
      sslWarningTitle: "Problema Certificato SSL / TLS",
      selfSignedNotice:
        "I certificati auto-firmati sono bloccati da Android per impostazione predefinita a livello TLS. Nessuna richiesta raggiunge il server Nextcloud (quindi i log del server sono vuoti). Usa un certificato valido (es. Let's Encrypt) o aggiungi il certificato a quelli attendibili di Android.",
      tutorial: {
    ...
    shoppingList: {
      ...
      notificationTitle: "Lista della spesa condivisa",
      notificationAdded: "Nuovi elementi sono stati aggiunti alla lista della spesa.",
      notificationRemoved: "Alcuni elementi sono stati rimossi dalla lista della spesa.",
      notificationAddedAndRemoved: "Sono stati aggiunti e rimossi elementi dalla lista della spesa.",
      ...
      sharedTitle: "Lista condivisa",
      sharedActiveLabel: "Lista condivisa attiva",
      sharedCodeHelp: "Condividi questo codice con partner o famiglia:",
      sharedLeave: "Esci dalla condivisione",
      sharedDescription: "Sincronizza la tua lista con un codice a 6 caratteri. Tutte le persone con questo codice vedranno la stessa lista in tempo reale.",
      sharedJoinBtn: "Unisciti alla lista",
      sharedCreateBtn: "Crea una lista condivisa",
      sharedCreateError: "Impossibile creare la lista condivisa.",
    ...
    community: {
      ...
      byAuthor: "Di {{author}}",
      emptyTitle: "Nessuna ricetta della community",
      emptyBody: "Sii il primo a condividere una ricetta con la community AvoCook!",
      submitFirst: "Condividi la prima ricetta",
      rateThisRecipe: "Valuta questa ricetta",
      translateRecipe: "Traduci ricetta",
      showOriginal: "Mostra originale",
      translating: "Traduzione in corso...",
      translationFailed: "Traduzione non riuscita",
      translatedNotice: "Traduzione automatica",
      voteCount: "{{count}} voti",
      importToMyRecipes: "Aggiungi alle mie ricette",
      voteFailedTitle: "Voto non riuscito",
      voteFailedBody: "Impossibile salvare il tuo voto.",
      importSuccessTitle: "Ricetta aggiunta! 🎉",
      importSuccessBody: "Questa ricetta è ora salvata tra le tue ricette.",
      viewMyRecipes: "Vedi le mie ricette",
      importFailedBody: "Impossibile importare la ricetta.",
      importDuplicateError: "Questa ricetta è già nel tuo ricettario.",
      reportTitle: "Segnala ricetta",
      reportConfirmBody: "Vuoi segnalare questa ricetta per contenuti inappropriati?",
      reportAction: "Segnala",
      reportedTitle: "Segnalazione ricevuta",
      reportedBody: "Grazie. Il nostro filtro ha registrato la tua segnalazione.",
      notFoundTitle: "Ricetta non trovata",
      submitTitle: "Pubblica una ricetta",
      submitPrivacyNotice: "Le ricette condivise qui sono visibili a tutti gli utenti AvoCook. Non inserire dati personali.",
      titlePlaceholder: "es. Torta di mele della nonna",
      descPlaceholder: "Breve descrizione o origine della ricetta",
      authorLabel: "Nome o nickname (opzionale)",
      authorPlaceholder: "es. Vocalle",
      anonymousAuthor: "cuoco AvoCook",
      selectLanguage: "Lingua della ricetta",
      ingredientsInputLabel: "Ingredienti (uno per riga)",
      stepsInputLabel: "Passaggi (uno per riga)",
      onePerLinePlaceholder: "Ingrediente 1\nIngrediente 2\n...",
      publishBtn: "Pubblica ricetta",
      missingTitleError: "Inserisci un titolo",
      profanityError: "Si prega di evitare di utilizzare parole inappropriate.",
      missingIngredientsError: "Inserisci almeno un ingrediente",
      submitSuccessTitle: "Ricetta pubblicata!",
      submitSuccessBody: "La tua ricetta è ora disponibile nella scheda Community.",
      submitFailedBody: "Impossibile pubblicare la ricetta.",
      duplicateRecipeError: "Una ricetta simile esiste già nella community.",
      importCategoryLabel: "Community",
      importKeyword: "community",
      shareConfirmTitle: "Condividere la ricetta?",
      shareConfirmBody: "Vuoi condividere questa ricetta con la community?",
      shareToCommunity: "Condividi nella community",
      duplicateTitle: "Duplicato rilevato",
      duplicateBody: "Esiste già una ricetta con lo stesso nome, autore o passaggi.",
      updateOrNewTitle: "Ricetta esistente",
      updateOrNewBody: "Hai già pubblicato una ricetta con questo nome. Vuoi aggiornare quella esistente o pubblicarne una nuova?",
      updateExisting: "Aggiorna",
      publishAsNew: "Pubblica come nuova",
      updateSuccessTitle: "Ricetta aggiornata!",
      updateSuccessBody: "La tua ricetta della community è stata aggiornata.",
      deleteTitle: "Elimina la mia ricetta",
      deleteConfirmBody: "Vuoi eliminare definitivamente la tua ricetta dalla community? Questa azione è irreversibile.",
      deletedTitle: "Ricetta eliminata",
      deletedBody: "La tua ricetta è stata rimossa dalla community.",
      deleteFailedBody: "Impossibile eliminare la ricetta. Riprova."
    },
    editor: {
      ...
      cholesterolMg: "Colesterolo (mg)",
      transFatGrams: "Grassi trans (g)",
      unsaturatedFatGrams: "Grassi insaturi (g)",
    ...
    importRecipe: {
      ...
      cropInstructionsTitle: "Inquadra il testo della ricetta",
      cropInstructionsBody: "Isola l'area contenente il testo della ricetta (titolo, ingredienti, passaggi) in modo che l'IA possa analizzarla. Successivamente potrai scegliere o ritagliare la foto del piatto.",
      mealPhotoTitle: "Foto del piatto",
      mealPhotoBody: "Vuoi aggiungere una foto del piatto finito alla tua ricetta?",
      mealPhotoPickNew: "Scegli foto del piatto",
      mealPhotoUseCurrent: "Usa foto attuale",
      mealPhotoSkip: "Nessuna foto",
    },
    settings: {
      switchToLocal: "Passa alla modalità locale",
      switchToNextcloud: "Passa a Nextcloud",
      switchToLocalConfirmTitle: "Passare alla modalità locale?",
      switchToLocalConfirmBody: "Le tue ricette Nextcloud non verranno più sincronizzate su questo dispositivo. Le tue ricette locali vengono conservate separatamente. Nessun dato viene perso!",
      switchToNextcloudConfirmTitle: "Passare a Nextcloud?",
      switchToNextcloudConfirmBody: "Le tue ricette locali attuali verranno conservate su questo dispositivo e sincronizzate con il tuo account Nextcloud. Nessun dato viene perso!",
      logoutConfirmTitle: "Disconnetti",
      logoutConfirmBody: "Le tue informazioni di connessione verranno eliminate da questo dispositivo.",
      title: "Impostazioni",
      profanityError: "Si prega di evitare di utilizzare parole inappropriate nel proprio pseudonimo.",
      appearance: "Aspetto",
      language: "Lingua",
      system: "Sistema",
      light: "Chiaro",
      ...
      shoppingNotifications: "Notifiche lista della spesa",
      shoppingNotificationsHint: "Notifica quando altri membri aggiungono o rimuovono elementi",
      server: "Server",
      ...
      communityPseudonym: "Pseudonimo (Community)",
      communityPseudonymHint: "Questo pseudonimo sarà utilizzato quando condividi le tue ricette con la community.",
      communityPseudonymPlaceholder: "Es: Chef Avo",
      pseudonymTaken: "Questo pseudonimo è già utilizzato da un altro utente. Scegliene uno diverso.",
      pseudonymSaveFailed: "Impossibile salvare lo pseudonimo. Riprova.",
      imageFolderPath: "Cartella immagini Nextcloud",
      imageFolderPathPlaceholder: "AvoCook Images",
      imageFolderPathHint: "Cartella in cui vengono salvate le foto delle ricette su Nextcloud. Lascia vuoto per usare la cartella predefinita «AvoCook Images».",
      imageFolderPathMigrationWarning: "Le foto già caricate nella cartella precedente (AvoCook Images) rimangono lì. Non verranno eliminate automaticamente quando le ricette vengono modificate.",
    },
    logs: {
      title: "Registri",
      refresh: "Aggiorna",
    ...
    privacy: {
      ...
      sharedListsAndCommunity:
        "Le liste della spesa condivise e le ricette della community utilizzano un archiviazione cloud sicura (Firebase) tramite un identificatore anonimo del dispositivo. Nessun account, e-mail o identità personale viene tracciata.",
      credentials:
    ...
    onboarding: {
      ...
      feature9Body: "Trovato un bug o hai un'idea? I pulsanti per contattare lo sviluppatore sono sempre nell'app — basta un tocco.",
      feature10Title: "Comunità",
      feature10Body: "Condividi, valuta e scopri ricette di altri utenti sulla piattaforma Comunità.",
      feature11Title: "Liste condivise",
      feature11Body: "Collabora alle tue liste della spesa in tempo reale tramite un codice a 6 cifre.",
    },
    tour: {
      skip: "Salta",
      ...
      stepCommunityTitle: "Comunità",
      stepCommunityBody: "Scopri, valuta e importa ricette dalla comunità AvoCook. Condividi i tuoi piatti migliori e crea il tuo profilo!",
      stepSharedListTitle: "Liste condivise",
      stepSharedListBody: "Collabora alle liste della spesa in tempo reale con un semplice codice a 6 cifre. Tutti restano sincronizzati!",
    ...
    update: {
      title: "Novità",
      subtitle: "Notifiche Push, Traduzioni Community e Correzioni (v4.0.1)",
      feat1Title: "Notifiche Push e Liste Condivise",
      feat1Body: "Ricevi notifiche push in tempo reale per gli aggiornamenti delle liste della spesa condivise e visualizza i partecipanti attivi.",
      feat2Title: "Traduzioni e Community",
      feat2Body: "Traduci le ricette della community direttamente nell'app, guarda le anteprime delle immagini ed esplora le ricette in tutte le lingue.",
      feat3Title: "Correzioni di Interfaccia",
      feat3Body: "Risolto il problema della tastiera nei campi descrizione, corretta la visualizzazione delle immagini locali e aggiunta la convalida dei nickname.",
      feat4Title: "Prestazioni e Ottimizzazioni",
      feat4Body: "Scorrimento delle liste reso più fluido e migrazione all'SDK modulare di Firebase per maggiore sicurezza e stabilità.",
      continue: "Continua alle mie ricette",
      settingsButton: "Novità di questa versione",
    },
  },
};
