export default {
  translation: {
    ...
    update: {
      ...
      feat2Body: "Il pulsante di scorrimento è stato sostituito con un indice alfabetico per trovare le tue ricette all'istante.",
      feat3Title: "Categorie preferite",
      feat3Body: "Aggiungi una stella alle tue categorie preferite per un accesso rapido. La categoria 'Altro' raggruppa le ricette senza categoria.",
      feat4Title: "Interfaccia semplificata",
      feat4Body: "I menu e le liste hanno pulsanti più chiari, ed è ora più facile passare dalla modalità Locale a quella Nextcloud.",
