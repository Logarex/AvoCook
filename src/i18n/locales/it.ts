export default {
  translation: {
    ...
    update: {
      ...
      subtitle: "Scopri le novità della versione 3.4.3",
      feat1Title: "Nuove lingue",
      feat1Body: "Aggiunto il supporto per la localizzazione danese e aggiornati i prompt di importazione delle ricette per mantenere la lingua originale.",
      feat2Title: "Libertà di installazione",
      feat2Body: "Rimossa la sicurezza Play Integrity di Google, permettendo ora di scaricare l'applicazione da altre fonti.",
      feat3Title: "",
      feat3Body: "",
      feat4Title: "",
      feat4Body: "",
