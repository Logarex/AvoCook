export default {
  translation: {
    ...
    update: {
      ...
      feat1Title: "Correzioni di stabilità",
      feat1Body: "Corretti i logout imprevisti dopo la chiusura dell'app, migliore persistenza della sessione su iOS e Android.",
      feat2Title: "Condivisione ricette corretta",
      feat2Body: "La condivisione da Safari o un'altra app verso AvoCook funziona di nuovo. I file .avocook possono ora essere condivisi direttamente.",
      feat3Title: "IA più accessibile",
      feat3Body: "La sezione IA è ora aperta per impostazione predefinita e i modelli disponibili si caricano automaticamente.",
      feat4Title: "Correzioni di visualizzazione",
      feat4Body: "I pulsanti di Registri e Impostazioni non vengono più troncati. Layout della sezione avanzata migliorato, senza sovrapposizioni.",
