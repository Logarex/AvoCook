export default {
  translation: {
    ...
    update: {
      title: "Novità",
      subtitle: "Aggiornamento Comunità e Spesa (v4.0.0)",
      feat1Title: "Piattaforma Comunitaria",
      feat1Body: "Condividi, valuta e importa ricette. Crea un profilo, usa metadati arricchiti e goditi uno spazio sicuro con la nuova moderazione.",
      feat2Title: "Liste della Spesa Condivise",
      feat2Body: "Collabora in tempo reale alla spesa con un semplice codice a 6 cifre e un nuovo indicatore di sincronizzazione.",
      feat3Title: "Miglioramenti dell'Interfaccia",
      feat3Body: "Selezione rapida delle categorie, modali migliori (ordine alfabetico), tipografia migliorata e normalizzazione dei caratteri.",
      feat4Title: "Sotto il cofano e Lingue",
      feat4Body: "Supporto per il danese, motore di traduzione completo e prestazioni ampiamente ottimizzate.",
