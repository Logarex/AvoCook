export default {
  translation: {
    ...
    update: {
      ...
      feat1Title: "Miglioramenti dell'interfaccia",
      feat1Body: "Migliorata l'accessibilità nell'introduzione, migliore visualizzazione di intestazioni e pulsanti. Aggiornato lo stile della barra laterale.",
      feat2Title: "Migliore localizzazione",
      feat2Body: "L'inglese è ora la lingua predefinita. Le porzioni ora usano la formattazione decimale adattata alla tua regione.",
      feat3Title: "Link di supporto",
      feat3Body: "Aggiunto un link diretto al sito web di supporto di AvoCook nella schermata delle impostazioni.",
      feat4Title: "Correzioni della modalità scura",
      feat4Body: "Il colore di sfondo della schermata di caricamento è stato aggiornato per adattarsi perfettamente alla modalità scura.",
