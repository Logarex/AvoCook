export default {
  translation: {
    ...
    update: {
      title: "Was ist neu?",
      subtitle: "Community- & Einkaufs-Update (v4.0.0)",
      feat1Title: "Community-Plattform",
      feat1Body: "Teile, bewerte und importiere Rezepte. Erstelle ein Profil, nutze erweiterte Metadaten und eine sichere Umgebung mit neuer Moderation.",
      feat2Title: "Geteilte Einkaufslisten",
      feat2Body: "Arbeite in Echtzeit an deinen Einkaufslisten mit einem einfachen 6-stelligen Code und Synchronisationsanzeige.",
      feat3Title: "Oberflächenverbesserungen",
      feat3Body: "Schnelle Kategorieauswahl, bessere Modalfenster (alphabetische Sortierung), verbesserte Typografie und Zeichennormalisierung.",
      feat4Title: "Unter der Haube & Sprachen",
      feat4Body: "Dänische Sprachunterstützung, vollständige Übersetzungs-Engine und stark optimierte Leistung.",
