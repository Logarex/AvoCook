export default {
  translation: {
    ...
    update: {
      ...
      feat1Title: "Stabilitätskorrekturen",
      feat1Body: "Unerwartete Abmeldungen nach dem Schließen der App wurden behoben, bessere Sitzungspersistenz auf iOS und Android.",
      feat2Title: "Teilen-Funktion korrigiert",
      feat2Body: "Das Teilen aus Safari oder einer anderen App zu AvoCook funktioniert wieder. .avocook-Dateien können jetzt direkt geteilt werden.",
      feat3Title: "KI einfacher zugänglich",
      feat3Body: "Der KI-Bereich ist jetzt standardmäßig geöffnet und verfügbare Modelle werden automatisch geladen, wenn ein Schlüssel konfiguriert ist.",
      feat4Title: "Anzeigeprobleme behoben",
      feat4Body: "Schaltflächen in Protokollen und Einstellungen werden nicht mehr abgeschnitten. Erweiterter Bereich verbessert, keine Überlappungen mehr.",
