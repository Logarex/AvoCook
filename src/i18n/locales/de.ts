export default {
  translation: {
    ...
    importRecipe: {
      ...
      incompleteRecipe: "Der automatische Import wird von dieser Seite blockiert. Der Autor hat wahrscheinlich das Teilen von Zutaten und Schritten deaktiviert, um seine Inhalte zu schützen.",
    },
    settings: {
    ...
    update: {
      ...
      subtitle: "Entdecken Sie die Neuerungen in Version 3.4.2",
      feat1Title: "Intelligentere Tastaturbehandlung",
      feat1Body: "Das Verhalten des KeyboardAvoidingView wurde angepasst und die Fokus- und Tipp-Interaktionen in der Einkaufsliste wurden optimiert.",
      feat2Title: "Bilder per URL hochladen",
      feat2Body: "Im Rezepteditor können Bilder jetzt direkt per Remote-URL hochgeladen werden, mit einem Echtzeit-Ladeindikator.",
      feat3Title: "Erweiterte Kategorie-Schlüsselwörter",
      feat3Body: "Die Schlüsselwortlisten für Rezeptkategorien wurden um mehrsprachige Begriffe und Synonyme erweitert, für eine präzisere automatische Kategorisierung.",
      feat4Title: "Bessere Kategoriezuordnung",
      feat4Body: "Die Kategoriezuordnung verwendet nun Wortgrenzen, und Anzeigebeschriftungen werden beim Umbenennen korrekt aufgelöst.",
