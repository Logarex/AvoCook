export default {
  translation: {
    ...
    update: {
      ...
      subtitle: "Entdecken Sie die Neuerungen in Version 3.4.0",
      feat1Title: "Schneller und leichter",
      feat1Body: "Die App wurde durch das Entfernen unnötiger Elemente optimiert, was zu einem schnelleren und stabileren Erlebnis führt.",
      feat2Title: "Alphabetische Navigation",
      feat2Body: "Die Scroll-Schaltfläche wurde durch einen alphabetischen Index ersetzt, damit Sie Ihre Rezepte sofort finden können.",
      feat3Title: "Lieblingskategorien",
      feat3Body: "Fügen Sie Ihren Lieblingskategorien einen Stern für den Schnellzugriff hinzu. Die Kategorie 'Andere' gruppiert Rezepte ohne Kategorie.",
      feat4Title: "Vereinfachte Benutzeroberfläche",
      feat4Body: "Menüs und Listen haben klarere Schaltflächen, und Sie können jetzt einfach zwischen dem lokalen und dem Nextcloud-Modus wechseln.",
