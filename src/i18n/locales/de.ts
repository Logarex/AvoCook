export default {
  translation: {
    ...
    update: {
      ...
      feat1Title: "Oberflächenverbesserungen",
      feat1Body: "Verbesserte Barrierefreiheit bei der Einführung, bessere Anzeige von Überschriften und Schaltflächen. Das Design der Seitenleiste wurde aktualisiert.",
      feat2Title: "Bessere Lokalisierung",
      feat2Body: "Englisch ist nun die Standardsprache. Für Portionsgrößen wird nun die an Ihre Region angepasste Dezimalformatierung verwendet.",
      feat3Title: "Support-Links",
      feat3Body: "Ein direkter Link zur AvoCook-Support-Website wurde in den Einstellungen hinzugefügt.",
      feat4Title: "Korrekturen für den Dunkelmodus",
      feat4Body: "Die Hintergrundfarbe des Ladebildschirms wurde aktualisiert, um sich perfekt an den Dunkelmodus anzupassen.",
