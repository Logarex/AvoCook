export default {
  translation: {
    ...
    update: {
      ...
      subtitle: "Entdecken Sie die Neuerungen in Version 3.4.3",
      feat1Title: "Neue Sprachen",
      feat1Body: "Dänische Lokalisierung hinzugefügt und Import-Prompts für Rezepte aktualisiert, um die Originalsprache beizubehalten.",
      feat2Title: "Installationsfreiheit",
      feat2Body: "Google Play Integrity-Sicherheit entfernt, sodass die Anwendung nun aus anderen Quellen heruntergeladen werden kann.",
      feat3Title: "",
      feat3Body: "",
      feat4Title: "",
      feat4Body: "",
