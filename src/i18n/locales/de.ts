export default {
  translation: {
    ...
    auth: {
      ...
      debugLogsTitle: "Logs & Fehlerbehebung",
      shareLogs: "Verbindungs-Logs & Fehlerbehebung",
      copied: "Kopiert!",
      logCount: "{{count}} aufgezeichnete Einträge",
      noLogsYet: "Noch keine Logs aufgezeichnet.",
      sslWarningTitle: "SSL / TLS Zertifikatsproblem",
      selfSignedNotice:
        "Selbstsignierte Zertifikate werden von Android standardmäßig auf TLS-Ebene blockiert. Es erreicht keine Anfrage den Nextcloud-Server (daher leere Server-Logs). Verwende ein gültiges Zertifikat (z.B. Let's Encrypt) oder füge das Zertifikat den vertrauenswürdigen Android-Zertifikaten hinzu.",
      tutorial: {
    ...
    shoppingList: {
      ...
      notificationTitle: "Geteilte Einkaufsliste",
      notificationAdded: "Neue Artikel wurden zur Einkaufsliste hinzugefügt.",
      notificationRemoved: "Artikel wurden aus der Einkaufsliste entfernt.",
      notificationAddedAndRemoved: "Artikel wurden hinzugefügt und aus der Einkaufsliste entfernt.",
      ...
      sharedTitle: "Geteilte Liste",
      sharedActiveLabel: "Geteilte Liste aktiv",
      sharedCodeHelp: "Teile diesen Code mit Partner oder Familie:",
      sharedLeave: "Teilen beenden",
      sharedDescription: "Verbinde deine Einkaufsliste mit einem 6-stelligen Code. Alle Personen mit diesem Code sehen dieselbe Liste in Echtzeit.",
      sharedJoinBtn: "Liste beitreten",
      sharedCreateBtn: "Geteilte Liste erstellen",
      sharedCreateError: "Liste konnte nicht erstellt werden.",
      sharedNotFoundError: "Liste nicht gefunden. Code prüfen.",
      sharedJoinError: "Beitreten fehlgeschlagen.",
      sharedShareMessage: "Tritt meiner Einkaufsliste auf AvoCook bei mit dem Code: {{code}}",
    ...
    community: {
      ...
      byAuthor: "Von {{author}}",
      emptyTitle: "Noch keine Community-Rezepte",
      emptyBody: "Teile als Erster ein Rezept mit der AvoCook-Community!",
      submitFirst: "Erstes Rezept teilen",
      rateThisRecipe: "Dieses Rezept bewerten",
      translateRecipe: "Rezept übersetzen",
      showOriginal: "Original anzeigen",
      translating: "Wird übersetzt...",
      translationFailed: "Übersetzung fehlgeschlagen",
      translatedNotice: "Automatisch übersetzt",
      voteCount: "{{count}} Stimmen",
      importToMyRecipes: "Zu meinen Rezepten hinzufügen",
      voteFailedTitle: "Bewertung fehlgeschlagen",
      voteFailedBody: "Deine Bewertung konnte nicht gespeichert werden.",
      importSuccessTitle: "Rezept hinzugefügt! 🎉",
      ...
      reportAction: "Melden",
      reportedTitle: "Meldung erhalten",
      reportedBody: "Vielen Dank. Unsere Moderation hat deine Meldung registriert.",
      notFoundTitle: "Rezept nicht gefunden",
      submitTitle: "Rezept veröffentlichen",
      submitPrivacyNotice: "Hier geteilte Rezepte sind für alle AvoCook-Nutzer sichtbar. Keine persönlichen Daten angeben.",
      ...
      onePerLinePlaceholder: "Zutat 1\nZutat 2\n...",
      publishBtn: "Rezept veröffentlichen",
      missingTitleError: "Bitte einen Titel eingeben",
      profanityError: "Bitte vermeiden Sie unangemessene Wörter.",
      ...
      shareConfirmTitle: "Rezept teilen?",
    ...
    editor: {
      ...
      cholesterolMg: "Cholesterin (mg)",
      transFatGrams: "Transfette (g)",
      unsaturatedFatGrams: "Ungesättigte Fette (g)",
    ...
    importRecipe: {
      ...
      cropInstructionsTitle: "Rezepttext ausschneiden",
      cropInstructionsBody: "Isoliere den Bereich mit dem Rezepttext (Titel, Zutaten, Schritte), damit die KI das Rezept analysieren kann. Anschließend kannst du das Foto des fertigen Gerichts auswählen oder zuschneiden.",
    ...
    settings: {
      ...
      switchToNextcloud: "Zu Nextcloud wechseln",
      switchToLocalConfirmTitle: "Zum lokalen Modus wechseln?",
      switchToLocalConfirmBody: "Ihre Nextcloud-Rezepte werden nicht mehr auf diesem Gerät synchronisiert. Ihre lokalen Rezepte werden separat aufbewahrt. Es gehen keine Daten verloren!",
      switchToNextcloudConfirmTitle: "Zu Nextcloud wechseln?",
      switchToNextcloudConfirmBody: "Ihre aktuellen lokalen Rezepte bleiben auf diesem Gerät erhalten und werden mit Ihrem Nextcloud-Konto synchronisiert. Es gehen keine Daten verloren!",
      logoutConfirmTitle: "Abmelden",
      logoutConfirmBody: "Ihre Verbindungsinformationen werden von diesem Gerät gelöscht.",
      title: "Einstellungen",
      profanityError: "Bitte vermeiden Sie unangemessene Wörter in Ihrem Pseudonym.",
      ...
      italian: "Italiano",
      danish: "Dänisch",
      sectionAppearance: "Aussehen & Sprache",
      sectionServer: "Server & Synchronisierung",
      sectionData: "Daten & Backups",
      sectionSupport: "Support & Informationen",
      ...
      shoppingNotifications: "Einkaufslisten-Benachrichtigungen",
      shoppingNotificationsHint: "Benachrichtigen, wenn Artikel von anderen Mitgliedern hinzugefügt oder entfernt werden",
      server: "Server",
      ...
      replayIntro: "Einführung & Tour wiederholen",
    ...
    privacy: {
      ...
      sharedListsAndCommunity:
        "Geteilte Einkaufslisten und Community-Rezepte nutzen sicheren Cloud-Speicher (Firebase) mit einer anonymen Geräte-ID. Es werden keine Konten, E-Mails oder persönlichen Daten erfasst.",
      credentials:
    ...
    support: {
      ...
      github: "Problem auf GitHub melden",
      website: "Webseite",
    ...
    onboarding: {
      values: "Kostenlos · Open Source · Keine Werbung · Keine Tracker",
      aboutTitle: "Von einem Studenten entwickelt",
      aboutBody:
        "AvoCook ist ein persönliches Projekt eines unabhängigen Studenten. Der Code ist vollständig öffentlich (Open Source), es gibt keine Werbung, keine Tracker und es ist komplett kostenlos.",
      localTitle: "Lokaler Modus",
      localBody:
        "Deine Rezepte bleiben vollständig auf deinem Gerät. Kein Konto erforderlich. Ideal, wenn du alles privat halten möchtest.",
      nextcloudTitle: "Nextcloud-Modus",
      nextcloudBody:
        "Synchronisiere deine Rezepte mit deinem persönlichen Nextcloud-Server. Greife von jedem Gerät darauf zu und lass sie automatisch sichern.",
      contactTitle: "Immer erreichbar",
      contactBody:
        "Schaltflächen zum Kontakt mit dem Entwickler sind jederzeit in der App verfügbar — um einen Fehler zu melden oder eine neue Funktion anzufordern.",
      next: "Weiter",
      featuresTitle: "Was kann AvoCook?",
      featuresSubtitle: "Hier ist ein kurzer Überblick über alle Funktionen.",
      start: "Los geht's",
      feature1Title: "Rezepte erstellen & bearbeiten",
      feature1Body: "Schreibe Rezepte von Grund auf mit Zutaten, Schritten, Fotos, Kategorien und Zubereitungs-/Kochzeiten.",
      feature2Title: "Von einer URL importieren",
      feature2Body: "Füge einen Rezept-Link ein und AvoCook extrahiert ihn automatisch. Teile eine Seite direkt aus dem Browser.",
      feature3Title: "Mit KI scannen",
      feature3Body: "Fotografiere eine Rezeptseite, handgeschriebene Notizen oder ein Gericht — die KI erstellt ein vollständiges Rezept. Du kannst auch ein Rezept per Text beschreiben.",
      feature4Title: "Einkaufsliste",
      feature4Body: "Füge Zutaten aus einem Rezept mit einem Tippen zur Einkaufsliste hinzu. Synchronisierung mit der iOS Erinnerungen-App.",
      feature5Title: "Kochzeitgeber",
      feature5Body: "Starte Vorbereitungs-, Koch- oder Gesamtzeitgeber für jedes Rezept. Sie klingeln über Benachrichtigungen auch im Hintergrund.",
      feature6Title: "Portionen anpassen",
      feature6Body: "Berechne Mengen sofort für beliebig viele Personen neu.",
      feature7Title: "Exportieren & teilen",
      feature7Body: "Drucke ein Rezept, exportiere es als PDF oder teile es mit einem anderen AvoCook-Nutzer.",
      feature8Title: "Backup & Sync",
      feature8Body: "Exportiere und importiere eine vollständige Backup-Datei. Synchronisiere mit Nextcloud Cookbook, wenn du einen Server hast.",
      feature9Title: "Kontakt-Buttons",
      feature9Body: "Ein Fehler gefunden oder eine Idee? Buttons, um den Entwickler zu erreichen, sind immer in der App verfügbar.",
      feature10Title: "Gemeinschaft",
      feature10Body: "Teile, bewerte und entdecke Rezepte anderer Benutzer auf der Community-Plattform.",
      feature11Title: "Geteilte Listen",
      feature11Body: "Arbeite in Echtzeit an deinen Einkaufslisten mit einem 6-stelligen Code zusammen.",
    },
    tour: {
      skip: "Überspringen",
      skipTitle: "Tutorial überspringen?",
      skipBody: "Du kannst es dir später in den Einstellungen ansehen.",
      skipConfirm: "Überspringen",
      next: "Weiter",
      finish: "Los geht's!",
      stepCounter: "{{current}} / {{total}}",
      step1Title: "Willkommen bei AvoCook",
      step1Body: "Die App, um all deine Rezepte an einem Ort zu speichern. Navigiere ganz einfach über die untere Leiste.",
      step2Title: "Rezept erstellen",
      step2Body: "Tippe auf das '+' Symbol, um eigene Rezepte mit Zutaten und Schritten hinzuzufügen.",
      step3Title: "Rezept importieren",
      step3Body: "Füge einen Internet-Link ein und AvoCook importiert das Rezept automatisch für dich.",
      step4Title: "KI-Scan",
      step4Body: "Mache ein Foto von einem Rezept und lass die Magie wirken. Erstelle einen kostenlosen Schlüssel auf der Seite deiner Wahl und füge ihn unter Einstellungen > Erweitert ein.",
      step5Title: "Kategorien",
      step5Body: "Ordne deine Rezepte, um sie schneller zu finden. Ein Gesundheits-Score wird angezeigt, wenn du Kalorien angibst.",
      step6Title: "Einkaufsliste",
      step6Body: "Füge Zutaten mit einem Fingertipp zur Einkaufsliste hinzu. Nie wieder etwas im Supermarkt vergessen!",
      step7Title: "Timer",
      step7Body: "Starte einen Timer direkt aus dem Rezept. Er klingelt auch, wenn dein Telefon gesperrt ist.",
      step8Title: "Einstellungen",
      step8Body: "Passe die App an. Denk daran, deine Daten ab und zu zu exportieren, um nichts zu verlieren.",
      step9Title: "Brauchst du Hilfe?",
      step9Body: "Wenn du eine Frage, ein Problem oder eine Idee hast, kontaktiere mich einfach direkt!",
      step10Title: "Auf die Plätze, fertig, kochen!",
      step10Body: "Du bist bereit! Du kannst dieses Tutorial jederzeit unter Einstellungen > Intro erneut abspielen ansehen.",
      stepCommunityTitle: "Gemeinschaft",
      stepCommunityBody: "Entdecke, bewerte und importiere Rezepte aus der AvoCook-Gemeinschaft. Teile deine besten Gerichte und erstelle dein Profil!",
      stepSharedListTitle: "Geteilte Listen",
      stepSharedListBody: "Arbeite in Echtzeit an Einkaufslisten mit einem einfachen 6-stelligen Code zusammen. Alle bleiben synchronisiert!",
      ...
      manageExport: "AvoCook-Datei: Exportieren Sie das Rezept als Datei. Sie oder ein Freund können es auf dem 'Importieren'-Bildschirm in Ihre Bibliothek aufnehmen.",
      manageSync: "Mit dem Server neu synchronisieren (nur nützlich, wenn Sie Nextcloud verwenden).",
      ...
      stepAppleBody: "Unter iOS können Sie AvoCook mit der Apple-System-App 'Erinnerungen' verknüpfen:",
    ...
    update: {
      title: "Was ist neu?",
      subtitle: "Push-Benachrichtigungen, Community-Übersetzungen & Korrekturen (v4.0.1)",
      feat1Title: "Push-Benachrichtigungen & Geteilte Listen",
      feat1Body: "Erhalte Echtzeit-Push-Benachrichtigungen bei Änderungen an geteilten Einkaufslisten und verfolge aktive Teilnehmer.",
      feat2Title: "Community & Rezept-Übersetzung",
      feat2Body: "Übersetze Community-Rezepte direkt in der App, sieh Bildvorschauen beim Durchstöbern und entdecke Rezepte in allen Sprachen.",
      feat3Title: "Korrekturen & Benutzeroberfläche",
      feat3Body: "Tastaturverhalten in Rezeptbeschreibungen behoben, korrekte Anzeige lokaler Bilder und Prüfung auf eindeutige Pseudonyme.",
      feat4Title: "Performance & Unter der Haube",
      feat4Body: "Optimiertes Laden der Listen für flüssiges Scrollen sowie Migration auf das modulare Firebase-SDK für höhere Sicherheit und Stabilität.",
      continue: "Weiter zu meinen Rezepten",
      settingsButton: "Neuigkeiten in dieser Version",
    },
  },
};
