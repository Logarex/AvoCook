export default {
  translation: {
    ...
    update: {
      title: "What's new?",
      subtitle: "Discover what's new in version 3.4.3",
      feat1Title: "New Languages",
      feat1Body: "Added Danish localization support and updated recipe import prompts to preserve original language.",
      feat2Title: "Installation Freedom",
      feat2Body: "Removed Google Play Integrity security, now allowing the application to be downloaded from other sources.",
      feat3Title: "",
      feat3Body: "",
      feat4Title: "",
      feat4Body: "",
