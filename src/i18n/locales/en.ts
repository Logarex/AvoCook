export default {
  translation: {
    ...
    update: {
      title: "What's new?",
      subtitle: "The Community Update & Shared Shopping Lists (v4.0.0)",
      feat1Title: "Community Recipe Platform",
      feat1Body: "Share, rate, and import recipes. Set up a profile, use rich metadata, and enjoy a safe space with our new moderation systems.",
      feat2Title: "Shared Shopping Lists",
      feat2Body: "Collaborate on grocery lists in real-time with others using a simple 6-digit code, now with a live sync indicator.",
      feat3Title: "UI Polish & Enhancements",
      feat3Body: "Quick category picker, improved modals with alphabetical sorting, better settings typography, and robust character normalization.",
      feat4Title: "Localization & Under the hood",
      feat4Body: "Full Danish support, complete translation engine, and heavily optimized performance for a snappier experience.",
