export default {
  translation: {
    ...
    update: {
      title: "What's new?",
      subtitle: "Discover what's new in version 3.4.2",
      feat1Title: "Smarter Keyboard Handling",
      feat1Body: "Adjusted KeyboardAvoidingView behavior and optimized shopping list input focus and tap handling for a smoother experience.",
      feat2Title: "Remote Image Upload",
      feat2Body: "Recipe editor now supports direct remote image upload with real-time loading states.",
      feat3Title: "Richer Category Keywords",
      feat3Body: "Expanded recipe category keyword lists with multilingual terms and synonym translations for more accurate auto-categorization.",
      feat4Title: "Better Category Matching",
      feat4Body: "Improved category matching using word boundaries, and category display labels now resolve correctly when renaming.",
