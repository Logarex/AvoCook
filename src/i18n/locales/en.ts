export default {
  translation: {
    ...
    shoppingList: {
      ...
      notificationTitle: "Shared shopping list",
      notificationAdded: "New items have been added to the shopping list.",
      notificationRemoved: "Items have been removed from the shopping list.",
      notificationAddedAndRemoved: "Items were added and removed from the shopping list.",
      ...
      sharedTitle: "Shared list",
      sharedActiveLabel: "Shared list active",
      sharedCodeHelp: "Share this code with your partner or family:",
      sharedLeave: "Leave sharing",
      sharedDescription: "Connect your list with a 6-digit code. Everyone using this code will see the same list in real-time.",
      sharedJoinBtn: "Join list",
      sharedCreateBtn: "Create a shared list",
      sharedCreateError: "Could not create shared list. Please try again.",
      sharedNotFoundError: "List not found. Please check the code.",
      sharedJoinError: "Error joining list. Please try again.",
      sharedShareMessage: "Join my shopping list on AvoCook using code: {{code}}",
    ...
    community: {
      ...
      emptyBody: "Be the first to share a recipe with the AvoCook community!",
      submitFirst: "Share the first recipe",
      rateThisRecipe: "Rate this recipe",
      translateRecipe: "Translate recipe",
      showOriginal: "Show original",
      translating: "Translating...",
      translationFailed: "Translation failed",
      translatedNotice: "Automatically translated",
      voteCount: "{{count}} votes",
      importToMyRecipes: "Add to my recipes",
      voteFailedTitle: "Vote failed",
      voteFailedBody: "Could not record your vote. Please try again.",
      importSuccessTitle: "Recipe added! 🎉",
      ...
      reportedBody: "Thank you. Our moderation filter has registered your report.",
      notFoundTitle: "Recipe not found",
      submitTitle: "Publish a recipe",
      submitPrivacyNotice: "Recipes shared here are visible to all AvoCook users. Do not include personal data.",
      ...
      onePerLinePlaceholder: "Ingredient 1\nIngredient 2\n...",
      publishBtn: "Publish recipe",
      missingTitleError: "Please enter a title",
      profanityError: "Please avoid using inappropriate words.",
    ...
    editor: {
      ...
      unsaturatedFatGrams: "Unsaturated fat (g)",
    ...
    importRecipe: {
      ...
      cropInstructionsTitle: "Frame the recipe text",
      cropInstructionsBody: "Isolate the area containing the recipe text (title, ingredients, steps) so the AI can analyze it. You will be able to choose or crop the meal photo next.",
    ...
    settings: {
      ...
      switchToNextcloud: "Switch to Nextcloud",
      switchToLocalConfirmTitle: "Switch to Local Mode?",
      switchToLocalConfirmBody: "Your Nextcloud recipes will no longer sync to this device. Your local recipes are kept separately. No data is lost!",
      switchToNextcloudConfirmTitle: "Switch to Nextcloud?",
      switchToNextcloudConfirmBody: "Your current local recipes will be kept on this device and synchronized with your Nextcloud account. No data is lost!",
      logoutConfirmTitle: "Logout",
      logoutConfirmBody: "Your connection information will be deleted from this device.",
      title: "Settings",
      profanityError: "Please avoid using inappropriate words in your pseudonym.",
      ...
      keepAwake: "Keep screen awake on recipes",
      ...
      shoppingNotifications: "Shopping list notifications",
      shoppingNotificationsHint: "Notify when items are added or removed by other members",
      server: "Server",
      ...
      imageFolderPath: "Nextcloud image folder",
      imageFolderPathPlaceholder: "AvoCook Images",
      imageFolderPathHint: "Folder where recipe photos are stored on Nextcloud. Leave empty to use the default \"AvoCook Images\".",
      imageFolderPathMigrationWarning: "Photos already uploaded to the previous folder (AvoCook Images) remain there. They won't be removed automatically when recipes change.",
    },
    logs: {
      title: "Logs",
      refresh: "Refresh",
    ...
    privacy: {
      ...
      sharedListsAndCommunity:
        "Shared shopping lists and community recipes use secure cloud database storage (Firebase) using an anonymous device identifier. No account, email, or personal identity is tracked.",
      credentials:
    ...
    onboarding: {
      ...
      feature10Title: "Community",
      feature10Body: "Share, rate, and discover recipes from other users on the Community platform.",
      feature11Title: "Shared lists",
      feature11Body: "Collaborate on your shopping lists in real-time using a 6-digit code.",
    },
    tour: {
      skip: "Skip",
      ...
      stepCommunityTitle: "Community",
      stepCommunityBody: "Discover, rate, and import recipes from the AvoCook community. Share your best meals and create your profile!",
      stepSharedListTitle: "Shared Lists",
      stepSharedListBody: "Collaborate on grocery lists in real-time with a simple 6-digit code. Everyone stays in sync!",
    ...
    update: {
      title: "What's new?",
      subtitle: "Push Notifications, Community Translations & Fixes (v4.0.1)",
      feat1Title: "Push Notifications & Shared Lists",
      feat1Body: "Get real-time push notifications when shared grocery lists are updated, and view active participants at a glance.",
      feat2Title: "Community & Recipe Translations",
      feat2Body: "Translate community recipes right inside the app, view image previews while browsing, and explore recipes in all languages.",
      feat3Title: "UI & Input Fixes",
      feat3Body: "Resolved keyboard erratic behavior in recipe descriptions, fixed local image display issues, and added unique pseudonym validation.",
      feat4Title: "Performance & Under the hood",
      feat4Body: "Throttled list reloads for smoother scrolling performance, and upgraded to modular Firebase SDK for improved security and stability.",
