export default {
  translation: {
    ...
    update: {
      title: "What's new?",
      subtitle: "Discover what's new in version 4.0.0",
      feat1Title: "Community Recipes",
      feat1Body: "Discover and share recipes with all AvoCook users.",
      feat2Title: "Real-time Shopping",
      feat2Body: "Synchronize and share your shopping lists instantly with your loved ones.",
      feat3Title: "Natural Gestures",
      feat3Body: "Easily navigate between your recipes, community, and shopping lists by swiping.",
      feat4Title: "Redesigned Interface",
      feat4Body: "New community card design and overall visual improvements.",
