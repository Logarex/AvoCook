export default {
  translation: {
    ...
    update: {
      ...
      feat1Title: "UI & Accessibility Improvements",
      feat1Body: "Improved accessibility for onboarding dots, enabled layout wrapping for headers, and prevented button label overflow. Updated recipe list sidebar styles.",
      feat2Title: "Better Localization",
      feat2Body: "Updated the default fallback language to English and added locale-aware decimal formatting for serving sizes.",
      feat3Title: "Support Links",
      feat3Body: "Added a direct link to the AvoCook support website in the Settings screen.",
      feat4Title: "Dark Mode Fixes",
      feat4Body: "Updated the loading screen background color to use a specific shade for dark mode.",
