export default {
  translation: {
    ...
    update: {
      ...
      feat2Body: "Sharing from Safari or any other app to AvoCook works again. .avocook files can now be shared directly too.",
      feat3Title: "AI more accessible",
      feat3Body: "The AI section is now open by default and available models load automatically when a key is configured.",
      feat4Title: "Display fixes",
      feat4Body: "Buttons in Logs and Settings are no longer truncated. Advanced section layout improved, no more overlapping.",
