export default {
  translation: {
    ...
    update: {
      ...
      feat2Body: "The scroll button has been replaced with an alphabetical index so you can find your recipes instantly.",
      feat3Title: "Favorite categories",
      feat3Body: "Add a star to your favorite categories for quick access. The 'Other' category groups recipes without a specific category.",
      feat4Title: "Simplified interface",
      feat4Body: "Menus and lists have clearer buttons, and you can now easily switch between Local and Nextcloud modes.",
